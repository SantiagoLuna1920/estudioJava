...
public class ArrayListCollectionMain {
    public static void main(String[] args) {
       ...
       // int sizeArrayList = items.size();
        System.out.printf("Size: %s%n", items.size()); //muestra el tamaño como String porque es un carácter de un solo bit
    }
